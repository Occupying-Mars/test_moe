...
batch_size = 32     # Increased batch size for higher throughput on an L4 24GB GPU
...
def decode(tokens):
    ...
    VOCAB_SIZE = 50304
    # Clamp each token into the valid range:
    ...
    with mlflow.start_run():
        ...
        for i in tqdm(range(max_iters), desc="Training"):
            ...
            if i % 100 == 0:
                ...
                # Use clamped decode to avoid invalid tokens.
